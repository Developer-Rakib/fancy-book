...
const Header = () => {
    ...
    return (
        <div className='pt-4 pb-10 nav z-10'>
            <img onClick={navBtnHndle} className='sm:hidden absolute right-5 top-5' width={25} src={toggle ? closeNav : openNav} alt="" />
            <ul className={`flex flex-col sm:flex-row justify-center absolute sm:relative sm:top-0 bg-white w-full py-2 duration-500 ease-out  ${toggle ? "top-12 opacity-100" : "top-[-250px] opacity-0"}`}>
